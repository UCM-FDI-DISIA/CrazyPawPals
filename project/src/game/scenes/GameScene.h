...
public:
	...
	static uint8_t spawn_sarno_rata(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE,  uint32_t _id = -1);
	static uint8_t spawn_michi_mafioso(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_plim_plim(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_boom(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_ratatouille(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_rata_basurera(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_rey_basurero(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);

	static uint8_t spawn_super_michi_mafioso(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
	static uint8_t spawn_catkuza(Vector2D posVec, ecs::sceneId_t scene = ecs::scene::GAMESCENE, uint32_t _id = -1);
